      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="bg-slate-900/40 rounded-[3rem] p-12 shadow-2xl border border-white/5 flex flex-col justify-between relative group">
          ...
          <div>
            ...
            <Tooltip content="Practice: Implement an Explicit Wait to catch the success message." position="bottom">
              <button 
                id="start-ajax-btn"
        ...
        <div className="bg-slate-900/40 rounded-[3rem] p-12 shadow-2xl border border-white/5 relative">
          ...
          <div className="flex items-center justify-center mb-12">
            <Tooltip content="Implicit waits won't work if element exists but is hidden. Use visibilityOf." position="top">
