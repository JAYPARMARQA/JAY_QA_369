...
const App: React.FC = () => {
  return (
    <Router>
      <div className="min-h-screen flex flex-col font-sans bg-slate-950 text-slate-100 relative overflow-x-hidden">
        ...
        <footer className="bg-slate-950 text-slate-500 py-12 mt-12 border-t border-slate-900 relative z-10">
          <div className="max-container mx-auto px-4 text-center space-y-4">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="font-black tracking-widest uppercase bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-400 via-indigo-400 to-cyan-400">JAY'S Automation Hub</span>
            </div>
            <p className="text-sm max-w-md mx-auto opacity-60">
              Master the grid. Own the locators. Practice for the elite automation roles in a dark, neon-lit environment.
            </p>
            ...
            <div className="pt-8 border-t border-slate-900 text-[10px] uppercase font-bold tracking-[0.2em] opacity-30">
